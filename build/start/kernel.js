...
Server_1.default.middleware.register([
    ...
    () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]('App/Middleware/LogRequest'))),
]);
Server_1.default.middleware.registerNamed({
    auth: () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]('App/Middleware/LogRequest'))),
});
